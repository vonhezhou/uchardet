...
class JohabProber extends CharSetProber {
  final CodingStateMachine _mCodingSM;

  final _mDistributionAnalyser = JohabDistributionAnalysis();

  final _mLastChar = Uint8List(2);

  final bool _mIsPreferredLanguage;
  JohabProber(bool aIsPreferredLanguage)
    : _mIsPreferredLanguage = aIsPreferredLanguage,
      _mCodingSM = CodingStateMachine(
        model: MBCSStateMachineModels.kJohabModel,
      ) {
    reset();
  }
