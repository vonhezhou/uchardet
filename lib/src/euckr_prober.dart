...
class EUCKRProber extends CharSetProber {
  ...
  final _mDistributionAnalyser = EUCKRDistributionAnalysis();

  final _mLastChar = Uint8List(2);

  final bool _mIsPreferredLanguage;
  EUCKRProber(bool aIsPreferredLanguage)
    : _mIsPreferredLanguage = aIsPreferredLanguage,
      _mCodingSM = CodingStateMachine(
        model: MBCSStateMachineModels.kEUCKRModel,
      ) {
    reset();
  }
